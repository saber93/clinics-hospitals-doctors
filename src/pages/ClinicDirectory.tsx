...
const ClinicDirectory = () => {
  ...
  useEffect(() => {
    ...
    const filtered = clinics.filter(clinic => {
      const matchesSearch = searchQuery === "" || clinic.name.toLowerCase().includes(searchQuery.toLowerCase()) || clinic.category.toLowerCase().includes(searchQuery.toLowerCase()) || clinic.subCategory.toLowerCase().includes(searchQuery.toLowerCase()) || clinic.description.toLowerCase().includes(searchQuery.toLowerCase());
      ...
      const matchesOffer = offerFilter === "all" || offerFilter === "offers" && clinic.offerPercentage > 0 || offerFilter === "no-offers" && clinic.offerPercentage === 0;
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              ...
              <div className="md:col-span-9">
                {filteredClinics.length === 0 ? <div className="text-center py-12">
                    ...
                    {filteredClinics.map(clinic => <div key={clinic.id} className="fade-in-up appear">
