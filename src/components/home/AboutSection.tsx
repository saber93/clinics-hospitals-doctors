    ...
    <section className="py-16 md:py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row gap-12">
        <div className="lg:w-1/2 relative">
          ...
          />
          <div className="absolute bottom-0 right-0 transform translate-y-1/4 translate-x-1/4 lg:-translate-x-1/4 bg-black text-white p-8 rounded-lg shadow-xl max-w-[300px]">
