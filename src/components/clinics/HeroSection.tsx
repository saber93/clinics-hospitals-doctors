  ...
  return (
    <div className="relative min-h-[500px] w-full overflow-hidden">
      ...
      <div className="absolute left-0 top-0 w-1/3 h-full hidden md:block z-10">
        ...
        {/* Second left image - moved further to the left */}
      ...
      <div className="absolute right-0 top-0 w-1/3 h-full hidden md:block z-10">
        ...
        {/* Middle right image - beauty products (bigger) */}
        <div className="w-40 h-40 pointer-events-none absolute right-48 top-96">
          <img 
            ...
            alt="Cosmetic beauty products" 
            className="w-full h-full object-cover rounded-lg shadow-lg"
          />
        </div>
        
        {/* Bottom right image - cosmetic procedure (smaller) */}
      ...
      <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center py-16 relative z-20">
        <div className="flex items-center gap-2 mb-6">
          ...
          <div className="bg-white p-1 rounded-lg">
            <div className="text-primary text-5xl font-bold">SURGERY</div>
          </div>
        </div>
        ...
        <p className="text-white text-lg md:text-xl mb-12 max-w-2xl">
          Discover top-rated plastic surgery clinics offering specialized cosmetic treatments tailored to your needs
        </p>
        
        {/* Feature badges */}
        <div className="flex flex-wrap justify-center gap-4">
          <FeatureBadge number="25+" label="COSMETIC PROCEDURES" />
          <FeatureBadge number="150+" label="SATISFIED CLIENTS" />
          <FeatureBadge number="15+" label="CERTIFIED SURGEONS" icon="star" highlight />
          <FeatureBadge number="24/7" label="PERSONALIZED CARE" />
        </div>
