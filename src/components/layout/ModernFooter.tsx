...
const ModernFooter: React.FC = () => {
  ...
  return (
    <footer className="bg-gray-50 dark:bg-gray-900 mt-auto pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 md:px-8 mb-8">
        <div className={cn("grid grid-cols-1 md:grid-cols-4 gap-8", isRTL && "text-right")}>
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-4">{t("home.subtitle")}</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/clinics" className="text-gray-500 hover:text-primary">
                  {t("common.clinics")}
                </Link>
              </li>
              <li>
                <Link to="/hospitals" className="text-gray-500 hover:text-primary">
                  {t("common.hospitals")}
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/about#business-model" className="text-gray-500 hover:text-primary">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className={cn("flex items-start", isRTL && "flex-row-reverse")}>
                ...
                <span className={cn("text-gray-500", isRTL ? "mr-1" : "ml-1")}>Dubai Healthcare City, UAE</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="border-t border-gray-200 dark:border-gray-800 pt-8">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className={cn("flex flex-col md:flex-row justify-between items-center", isRTL && "flex-row-reverse")}>
            <p className="text-sm text-gray-500 dark:text-gray-400">© 2025 ZAMES. {t("footer.allRightsReserved")}</p>
