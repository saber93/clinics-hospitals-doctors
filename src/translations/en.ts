export default {
  ...
  home: {
    welcome: 'Welcome to ZAMES',
    subtitle: 'Connecting Healthcare Specialists & Clients',
    ...
    joinThousands: 'Join thousands of happy clients who have found their perfect healthcare match through ZAMES. Your journey to better health is just a click away.',
    ...
    marketLeaders: 'MARKET LEADERS IN STRATEGIC GROWTH',
    boostBrand: 'Boost Your Brand Presence With Our Expertise, Smart Vision',
    journeyTitle: 'OUR JOURNEY TO MARKETING EXCELLENCE',
    realMarketing: 'Real Marketing, Real Results',
    journeyDescription: 'From overcoming marketing failures to leading in performance-based strategies, we transformed our challenges into success. At ZAMES, we redefine marketing by focusing on real, measurable growth—ensuring businesses thrive without financial risks.',
    ourBeginning: 'Our Beginning',
    year2012: '2012',
    fashionIndustry: 'Fashion & Makeup Industry',
    startingPoint: 'The starting point of our journey into real marketing solutions.',
    marketingTransformation: 'Marketing Transformation',
    year2020: '2020',
    selfMarketing: 'Self-Marketing Strategy',
    inHouseTeam: 'Built an in-house team, shifting from design-focused to result-driven campaigns.',
    industryExpansion: 'Industry Expansion',
    year2022: '2022',
    healthcareMarketing: 'Beauty & Healthcare Marketing',
    revolutionizing: 'Revolutionizing client acquisition for clinics and medical professionals.',
    founded: 'Founded',
    year2025: '2025',
    performanceBased: 'Performance-Based Marketing',
    dataModel: 'Turning past failures into a data-driven success model.',
    latestBlog: 'Latest from Our Blog',
    stayInformed: 'Stay informed with our latest research, resources, and insights'
  },
  about: {
    title: 'About Us',
  ...
  contact: {
    ...
    sendMessage: 'Send Message',
    sending: 'Sending...',
    officeAddress: 'UAE —15h Street, Office 478 - Dubai, B.O. 81566',
    emailUs: 'Email Us',
    callUs: 'Call Us',
    followUs: 'Follow Us',
    hours: 'Hours',
    ...
    messageHelp: 'How can we help you? Feel free to get in touch!',
    agreeToDataCollection: 'I agree that my data is collected and stored',
    agreeToTerms: 'Please agree to the data collection terms',
